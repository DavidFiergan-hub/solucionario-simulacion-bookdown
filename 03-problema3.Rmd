...
## Código de verificación y gráfico en Python.
...
# Cálculo exacto del término pedido
x_51202 = secuencia[51202 % m]
u_51202 = x_51202 / m

print(f"Valor de X_51202: {x_51202}")
print(f"Valor de U_51202: {u_51202:.9f}")

# Gráfico de dispersión de pares consecutivos (U_n vs U_{n+1})
u_secuencia = np.array(secuencia) / m
plt.figure(figsize=(6, 5))
plt.scatter(u_secuencia[:-1], u_secuencia[1:], s=10, color="#20639b", alpha=0.6)
plt.title("Estructura de Reticulado: $U_n$ vs $U_{n+1}$", fontsize=12)
plt.xlabel("$U_n$")
plt.ylabel("$U_{n+1}$")
