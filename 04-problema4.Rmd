...
## Código de simulación y distribución en Python.
...
print("-" * 50)
print(f"Número medio de sobres: {media_sobres:.2f} +/- {error_est:.2f}")
print(f"Gasto medio estimado:   ${gasto_medio:.2f}")
print(f"Mínimo sobres (95%):    {p95_sobres}")

# Histograma de distribución del número de sobres
plt.figure(figsize=(7.5, 4.2))
plt.hist(resultados_sobres, bins=35, density=True, color="#20639b", edgecolor="white", alpha=0.8)
plt.axvline(media_sobres, color="#e74c3c", linestyle="--", linewidth=2, label=f"Media: {media_sobres:.2f} sobres")
plt.axvline(p95_sobres, color="#f39c12", linestyle=":", linewidth=2, label=f"Percentil 95: {p95_sobres} sobres")
plt.title("Distribución de Sobres para Completar el Álbum (M = 1000)", fontsize=12)
plt.xlabel("Número de sobres requeridos")
